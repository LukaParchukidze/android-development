...
object HttpRequest {
    ...
    const val SONGS = "5ec3ca1c300000e5b039c407"
    ...
    fun putRequest(path: String, id:String, parameters: Map<String, String>, callback: CustomCallback) {
        val call = service.putRequest(path, id, parameters)
        call.enqueue(onCallBack(callback))
    }
